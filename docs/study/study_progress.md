...
- [ ] Sparse nonlinear validation accepted as calibration.
...
- Current claim boundary: calibrated local Fisher/Asimov forecast with
  deterministic PyAutoLens truth-likelihood sanity checks. Full global nonlinear
  search remains a separate sampler-engineering problem.
